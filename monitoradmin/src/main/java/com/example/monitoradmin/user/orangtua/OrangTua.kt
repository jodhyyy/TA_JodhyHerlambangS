...
import com.example.monitoradmin.databinding.ActivityOrangTuaBinding
...
class OrangTua : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.back.setOnClickListener {
            val intent = Intent(this@OrangTua, User::class.java)
        ...
        fab.setOnClickListener {
            val intent = Intent(this@OrangTua, UploadOrangTua::class.java)
            startActivity(intent)
        }
    }
