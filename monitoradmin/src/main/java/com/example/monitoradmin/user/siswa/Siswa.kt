...
import com.example.monitoradmin.databinding.ActivitySiswaBinding
...
class Siswa : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.back.setOnClickListener {
            val intent = Intent(this@Siswa, User::class.java)
        ...
        fab.setOnClickListener {
            val intent = Intent(this@Siswa, UploadSiswa::class.java)
            startActivity(intent)
        }
    }
